...
public class FormActivity extends AppCompatActivity {
        ...
        addTaskButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(enteredTask)){
                    Toast.makeText(FormActivity.this, "You must enter a task first", Toast.LENGTH_LONG).show();
                    return;
                }
                if(enteredTask.length() < 6){
                    Toast.makeText(FormActivity.this, "Task count must be more than 6", Toast.LENGTH_LONG).show();
                    return;
                }
                Task taskObject = new Task(enteredTask);
                mFirebaseDatabase.push().setValue(taskObject);
                //mFirebaseDatabase.push().setValue(taskObject);
                addTaskBox.setText("");
            }
        });
    ...
    private void getAllTask(DataSnapshot dataSnapshot){
        for(DataSnapshot singleSnapshot : dataSnapshot.getChildren()){
            ...
            recyclerViewAdapter = new RecyclerViewAdapter(FormActivity.this, allTask);
